...
import { BigNumberish, Signature, Signer, TypedDataDomain } from "ethers";
import {
    OrderParameters,
    OrderComponents,
    CreateInputItem,
...
export const createOrder = async (input: CreateOrderInput): Promise<OrderParameters> => {
    ...
    return {
        ...
        startTime: input.startTime as BigNumberish,
        endTime: input.endTime as BigNumberish,
